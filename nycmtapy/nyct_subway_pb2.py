...
_NYCTTRIPDESCRIPTOR_DIRECTION = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="NORTH", index=0, number=1, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="EAST", index=1, number=2, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="SOUTH", index=2, number=3, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="WEST", index=3, number=4, options=None, type=None
        ),
    ],
    containing_type=None,
    options=None,
...
_TRIPREPLACEMENTPERIOD.fields_by_name[
    "replacement_period"
].message_type = gtfs__realtime__pb2._TIMERANGE
